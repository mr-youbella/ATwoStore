				...
				<div className="flex justify-between items-center xl:w-3/4 xl:mx-auto">
					<div className="flex items-center gap-3">
						...
						<div>
							...
							<p className="text-[#68788F] text-xs font-medium">{name_page}</p>
						</div>
					</div>
					<div className="flex items-center gap-2">
						...
						<button hidden={name_page === t.loginSubtitle || name_page === t.registerSubtitle || name_page === t.verifySubtitle} onClick={() => router.push("/settings")} className="w-9 h-9 rounded-xl border border-gray-300 flex items-center justify-center text-[#505F76] cursor-pointer hover:border-[#4F46E5] hover:text-[#4F46E5] transition-all duration-300">
