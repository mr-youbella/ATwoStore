...
export default function OrdersPage()
{
	...
	const { loading_orders, search, filter, page, expanded, filtered, paginated, totalPages, perPage, stats, lang_loading, t, lang, FILTERS, setSearch, setFilter, setPage, setExpanded, downloadOrder, downloadBl, sendOrder, toggleLang, handleDeleteOrder } = useOrders();
	useEffect(() =>
	{
